...
export default function AddManager() {
  ...
  let LoginUser = useContext(StoreContext).LoginUser;
  ...
  // }
  function handler() {
    console.log(LoginUser[0]._id,"hhhhhhhhhhhhhhhh");
    axios({
      method: 'post',
      ...
      data: {
        ...
        LoginId: LoginId,
        Password: Password,
        CraetedBy: LoginUser[0]._id,
        Role: value,
      },
    })
      .then(res => {
        console.log(res.data, 'Add Manager Response');
        Alert.alert('Manager Create Successfully Add');
      })
      .catch(err => {
        console.log(err);
      });
          ...
          <View
            ...
            <View style={styles.container}>
              ...
              <TouchableOpacity style={styles.loginBtn}>
                <Text style={{fontSize: 30, color: 'white'}} onPress={handler}>
                  Next
                </Text>
              </TouchableOpacity>
            </View>
